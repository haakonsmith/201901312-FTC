...
/**
 * One stick linear remote control uses linear mapping and one stick for both turning and driving
 */
@TeleOp(name="One stick Linear Remote Control", group="Linear Opmode")
//@Disabled
public class RobotLinearOneStickTankControl extends LinearOpMode {
